...
class ConnectionManager_I
{
  public:
    ...
    virtual bool sendEncoded(const NodeId& nodeId, EncodedMessage&& encoded) = 0;
...
class ConnectionManager : public ConnectionManager_I
{
  public:
    ...
    bool sendEncoded(const NodeId& nodeId, EncodedMessage&& encoded) override {return false;}
